...
//   });
//   console.log(profileData?.user?.isAdmin);
...
const navigation = [
  ...
  // This item will be conditionally rendered based on the isAdmin flag
  {
    name: "Create Plan",
    href: "/dashboard/create-plan",
    icon: FaCalendarPlus,
    current: false,
    adminOnly: true, // Custom property to indicate admin-only item
  },
];
